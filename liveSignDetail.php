...
$con = str_replace('{{service_fee_month}}', isset($data['service_fee_month']) ? $data['service_fee_month'] : '', $con);
...
$con = str_replace('{{service_totle_fee}}', isset($data['service_totle_fee']) ? $data['service_totle_fee'] : '', $con);
$con = str_replace('{{discount_month_fee}}', isset($data['discount_month_fee']) ? $data['discount_month_fee'] : '', $con);
$con = str_replace('{{service_discount_month}}', isset($data['service_discount_month']) ? $data['service_discount_month'] : '', $con);
...
$con = str_replace('{{month_money}}', isset($data['month_money'])?$data['month_money']:'', $con);
